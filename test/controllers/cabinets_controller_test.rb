...
class CabinetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cabinet" do
    assert_difference('Cabinet.count') do
      post cabinets_url, params: { cabinet: { archive: @cabinet.archive, description: @cabinet.description, lieu_id: @cabinet.lieu_id, nom: @cabinet.nom } }
    end
  ...
  test "should update cabinet" do
    patch cabinet_url(@cabinet), params: { cabinet: { archive: @cabinet.archive, description: @cabinet.description, lieu_id: @cabinet.lieu_id, nom: @cabinet.nom } }
