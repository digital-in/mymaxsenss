...
class AffectationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create affectation" do
    assert_difference('Affectation.count') do
      post affectations_url, params: { affectation: { cabinet_id: @affectation.cabinet_id, creneau_id: @affectation.creneau_id, datedebut: @affectation.datedebut, datefin: @affectation.datefin, praticien_id: @affectation.praticien_id } }
    end
  ...
  test "should update affectation" do
    patch affectation_url(@affectation), params: { affectation: { cabinet_id: @affectation.cabinet_id, creneau_id: @affectation.creneau_id, datedebut: @affectation.datedebut, datefin: @affectation.datefin, praticien_id: @affectation.praticien_id } }
